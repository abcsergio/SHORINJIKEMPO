...
class __TwigTemplate_d6955708c4aaebd76676631023561493 extends Template
{
    private $source;
    private $macros = [];
...
<img src=";
    ...
    <hr>
        ...
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("photos/article/" . twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 20, $this->source); })()), "photo", [], "any", false, false, false, 20))), "html", null, true);
        echo "\" style=\"width:100%\" /> </div>
                    
                    <p class=\"about\">";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 22, $this->source); })()), "description", [], "any", false, false, false, 22), "html", null, true);
        echo "</p>
...
<img src={{asset('photos/autre/shorinjiKempo_blanc.png')}} width = \"100%\">
    ...
    <hr>
            ...
            <h3>{{ article.titre }}</h3>
                        <div class=\"text-center p-4\"> <img id=\"img-fluid\" src=\"{{ asset('photos/article/' ~ article.photo ) }}\" style=\"width:100%\" /> </div>
